...
%prep
%setup -q -n libclc-11.1.0.src
cd %{_builddir}/libclc-11.1.0.src
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618932947
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libclc-11.1.0.src/LICENSE.TXT %{buildroot}/usr/share/package-licenses/libclc/8737af83de0d40386dca9a4abe2b6faa83cb4750
pushd clr-build-avx2
%make_install_avx2  || :
popd
pushd clr-build
